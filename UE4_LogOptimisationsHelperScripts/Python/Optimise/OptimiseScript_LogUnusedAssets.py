...
with unreal.ScopedSlowTask(len(allAssets), selectedAssetsPath) as ST:
    ...
    for asset in allAssets:
        ...
        _dependencies = EditAssetLib.find_package_referencers_for_asset(asset, True)  # True = load all assets
        # unreal.log(_dependencies)
...
# //////////////////////////////
TitleOfOptimisation = "Log Unused Project Assets"
DescOfOptimisation = "Searches the entire project for assets that have 0 references, that we could consider deleting"
